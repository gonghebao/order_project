	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="toBoardList.do">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="toCuisineList.do">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="toFoodList.do">菜品管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="toFrderList.do">餐厅订单</a>
				</li>
            </ul>
        </li>
    </ul>
