		...
		<div id="index_center">
			...
			<div id="center_bottom">
				<ul style=" display:inline-table">
					<c:forEach items="${table}" var="c1">
						<li>
							<c:if test="${c1.tableStatus==1}">
								<a href="caidan.web?tableId=${c1.id}" style="color:red">${c1.tableName}&nbsp;</a>
							</c:if>
							<c:if test="${c1.tableStatus==0}">
								<a href="caidan.web?tableId=${c1.id}">${c1.tableName}&nbsp;</a>
							</c:if>
						</li>
					</c:forEach>
				</ul>
