...
img{
	...
	<div id="Head_1">
		...
		<div id="Head_1_FunctionButton">
			...
			<a target="_parent" href="tologin.do">
...
<div class="margin_10">
	<div class="index_left">
	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style" style="padding-bottom:10px;">
                    <a target="right" href="toBoardList.do" style="font-size:12px">餐桌管理</a>
				</li>
                <li class="level2 level2Style" style="padding-bottom:10px;">
                	<a target="right" href="toCuisineList.do" style="font-size:12px">菜系管理</a>
				</li>
                <li class="level2 level2Style" style="padding-bottom:10px;">
                	<a target="right" href="toFoodList.do" style="font-size:12px">菜品管理</a>
				</li>
                <li class="level2 level2Style" style="padding-bottom:10px;">
                	<a target="right" href="toFrderList.do" style="font-size:12px">餐厅订单</a>
				</li>
            </ul>
        </li>
    </ul>
