...
<div id="Head_1">
	...
	<div id="Head_1_FunctionButton">
		...
		</a> <a target="_parent" href="javascript:void(0)"> <img width="78"
	...
	<div class="index_right">
		...
		<div id="MainArea">
			<table class="MainArea_Content" align="center" cellspacing="0"
				...
				<thead>
					<tr align="center" valign="middle" id="TableTitle">
						<td width="100px">菜名ID</td>
						<td width="100px">菜名</td>
				...
				<tbody id="TableData">
					<c:forEach items="${list}" var="i">
						<tr align="center" valign="middle" height="60">
							<td width="100px">${i.foodid }</td>
							<td width="100px">${i.name }</td>
							<td width="100px">${i.price}</td>
			...
			<div id="TableTail" align="center">
				<a href="javascript:history.go(-1);" class="FunctionButton"
					style="color: #005294">返回</a>
			</div>
		</div>
	</div>
</div>
