...
<div class="margin_10">
	...
	<div class="index_right_container">
		<div class="index_right">
			...
			<!-- 过滤条件 -->
			<%-- <div id="QueryArea">
		<form action="cuisineList.do" method="get">
			<input type="hidden" name="method" value="search">
			<input type="text" name="keyword" title="请输入菜系名称">
			<input type="submit" value="搜索" onclick="search(${c.id})">
		</form>
	</div> --%>
			...
			<div id="MainArea">
				<table class="MainArea_Content" align="center" cellspacing="0"
					...
					<!--显示数据列表 -->
					<tbody id="TableData">
						<c:forEach items="${cuisine }" var="c">
							<tr>
								<td>${c.id }</td>
								<td>${c.foodtype }</td>
								<td><a href="viewUpdate.do?id=${c.id }&type=${c.foodtype}"
									class="FunctionButton" style="color: #005294">更新</a> <a
									href="delCuisine.do?id=${c.id}&type=${c.foodtype}"
									class="FunctionButton" style="color: #005294">删除</a></td>
							</tr>
						</c:forEach>
				...
				<div id="TableTail" align="center">
					<div class="FunctionButton">
						<a href="toAddCuisine.do" style="color: #005294">添加</a>
					</div>
				</div>
			</div>
