...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="saveCuisine.do" method="post">
		<!-- 本段标题（分段标题） -->
				...
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								<input type="text" name="foodtype" class="InputStyle" value="foodtype"/> *
		...
		<div id="InputDetailBar">
			 <input type="submit" value="添加" class="FunctionButtonInput"style="color:#005294" >
