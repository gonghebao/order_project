		...
		<div id="MainArea">
			...
			<form action="UpdateFood.do" method="post"
				...
				<div class="ItemBlockBorder">
					<div class="ItemBlock">
						<input type="hidden" readonly value="${c.id}" name="id" />
						<div class="ItemBlock2">
							<table cellpadding="0" cellspacing="0" class="mainForm">
								<tr>
									...
									</select> <!--  <select name="cid" style="width:80px">
                             ...
                             *<input type="hidden" name="id" value="1" /> -->
								...
								<tr>
									<td>简介</td>
									<td><textarea name="introduce" class="TextareaStyle">${c.remark}</textarea></td>
								</tr>
								<tr>
									<td width="80px">菜品图片</td>
									<td><img
										style='max-width: 68px; width: 68px; width: expression(width &amp; amp; gt; 68 ? "68 px " : width "px"); max-width: 68px;'
										src="style/images/baizhuoxia.jpg"> <input type="hidden"
										name="image" value="baizhuoxia.jpg"> <input
										type="file" name="imageUrl" id="img" /></td>
								</tr>
							</table>
						</div>
					</div>
				...
				<div id="InputDetailBar">
					...
					<a href="javascript:history.go(-1);" class="FunctionButton" style="color:#005294">返回</a>
				</div>
			</form>
